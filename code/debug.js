...
newPlugin('ShowFrameNumber(b:scroll, i:offset, d:x, d:y, q:font, i:size, c:text_color, c:halo_color, d:font_width, d:font_angle)');
newPlugin('ShowSMPTE(d:fps, q:offset, i:offset_f, d:x, d:y, q:font, i:size, c:text_color, c:halo_color, d:font_width, d:font_angle)');
