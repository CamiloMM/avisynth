...
var addPlugin     = require('./plugin-system').addPlugin;
var utils         = require('./utils');

// This file contains helpers to make it easier to add core filters as plugins.
// It was in the plugin-definitions file, but it started to become too complex so
// I encapsulated it here instead. It may be eventually exposed to external usage.
